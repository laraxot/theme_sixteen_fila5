{{-- Bootstrap Italia Alert Component --}}
@props([
...
$alertClasses = match($type) {
    'success' => 'alert-success-italia',
    'warning' => 'alert-warning-italia',
    'danger' => 'alert-danger-italia',
    default => 'alert-info-italia',
};
...
<div {{ $attributes->merge(['class' => $alertClasses, 'role' => $role]) }}
    ...
    <div class="flex items-start">
        ...
        <div class="flex-shrink-0 ml-4">
            <button type="button" 
                    @click="show = false"
                    class="inline-flex text-current hover:opacity-75 focus:outline-none focus:opacity-75 transition-opacity">
                <span class="sr-only">Chiudi avviso</span>

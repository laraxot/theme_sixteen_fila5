...
\`\`\`bash
qmd search "<topic>" -c sixteen
# Cerca solo in ./laravel/Themes/Sixteen/docs/wiki/
\`\`\`
...
\`\`\`bash
qmd search "form" -c sixteen  # Solo questo modulo
\`\`\`
...
| Ricerca lenta | Limita con `-c sixteen` |

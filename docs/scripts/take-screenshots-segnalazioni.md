...
- **env**: `BASE_URL` (default http://127.0.0.1:8000), `OUTPUT_DIR` (default docs/screenshots/segnalazioni-elenco)
- **target**: http://localhost:8000/it/tests/segnalazioni-elenco

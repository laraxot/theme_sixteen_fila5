...
<<<<<<< HEAD
[![Module](https://img.shields.io/badge/Module-Segnalazione Pages Parity - Index-8B0000.svg)]()
...
| Template | Path |
|----------|------|
| segnalazione-dettaglio | `resources/views/components/blocks/tests/ticket-detail.blade.php` |

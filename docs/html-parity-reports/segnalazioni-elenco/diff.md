...
-                    <button class="btn btn btn-primary mobile-full py-3 mt-2 mb-4 mb-lg-0">
-                      <span>
-          <div id="data-ex-disservizio2" class="tab-pane fade" role="tabpanel">
-            <div class="row">
...
-                                            <div>
-                                              <img class="img-fluid w-100 mb-3 mb-lg-0">
-                                            <div>
-                                              <img class="img-fluid w-100 mb-3 mb-lg-0">
-                                            <div>
...
-              <button class="btn btn btn-outline-primary mobile-full py-3 mt-10 mx-auto">
-                <span>
-            <div class="col-lg-6 mt-50 mb-4 mb-lg-0">
-              <div class="cmp-text-button mt-0">
-                <h2 class="title-xxlarge mb-0">
...
-    <div id="modal-disservizio" class="modal fade" role="dialog">
-      <div class="modal-dialog" role="document">
-        <div class="modal-content">
-          <div class="modal-header">
-            <h2 id="modal2Title" class="modal-title title-small-semi-bold">

...
type: concept
theme: Sixteen
tags: [sixteen, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Sixteen theme filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe nel tema `Themes/Sixteen` estende una classe `Filament\...` direttamente.

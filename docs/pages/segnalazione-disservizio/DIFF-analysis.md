# DIFF Analysis: segnalazione-disservizio
...
## URL
- Reference: https://italia.github.io/design-comuni-pagine-statiche/sito/segnalazione-disservizio.html
- Local: http://127.0.0.1:8000/it/tests/segnalazione-disservizio

## Metriche HTML
| Metrica | Reference | Local |
|---------|-----------|-------|
| Righe HTML | 40 | 560 |
| Caratteri HTML | 7497 | 36572 |
...
<main data-page="segnalazione-disservizio">

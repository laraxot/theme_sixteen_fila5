...
## URL
- Reference: https://italia.github.io/design-comuni-pagine-statiche/sito/luogo-dettaglio.html
- Local: http://127.0.0.1:8000/it/tests/luogo-dettaglio

## Metriche HTML
| Metrica | Reference | Local |
|---------|-----------|-------|
| Righe HTML | 40 | 528 |
| Caratteri HTML | 7497 | 33794 |
...
<main data-page="luogo-dettaglio">

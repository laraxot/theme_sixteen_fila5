# DIFF Analysis: persona-dettaglio
...
## URL
- Reference: https://italia.github.io/design-comuni-pagine-statiche/sito/persona-dettaglio.html
- Local: http://127.0.0.1:8000/it/tests/persona-dettaglio

## Metriche HTML
| Metrica | Reference | Local |
|---------|-----------|-------|
| Righe HTML | 40 | 528 |
| Caratteri HTML | 7497 | 33802 |
...
<main data-page="persona-dettaglio">

# DIFF Analysis: richiesta-assistenza
...
## URL
- Reference: https://italia.github.io/design-comuni-pagine-statiche/sito/richiesta-assistenza.html
- Local: http://127.0.0.1:8000/it/tests/richiesta-assistenza

## Metriche HTML
| Metrica | Reference | Local |
|---------|-----------|-------|
| Righe HTML | 40 | 560 |
| Caratteri HTML | 7497 | 36560 |
...
<main data-page="richiesta-assistenza">

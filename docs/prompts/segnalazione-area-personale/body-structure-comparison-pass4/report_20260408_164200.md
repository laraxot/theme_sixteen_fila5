...
| Structure lines (URL2)        | 832        |
| Lines only in URL1            | 513      |
| Lines only in URL2            | 459      |
| Structural similarity          | 43.4%    |
| Total elements (URL1)         | 886 |
| Total elements (URL2)         | 832 |
| data-element attrs (URL1)     | 16 |
| data-element attrs (URL2)     | 14 |
...
| Metric | URL1 | URL2 |
|--------|------|------|
| Elements with data-element | 16 | 14 |

...
<a class="btn btn-outline-light btn-icon" href="..." data-element="personal-area-login" aria-label="Accedi all'area personale">
<a class="chip chip-simple" href="...">
<a class="d-lg-block navbar-brand" target="_blank" href="..." aria-label="Vai al portale {Nome della Regione} - link esterno - apertura nuova scheda" title="...">
...
<br>
<br>
<button class="btn btn-outline-primary fw-bold me-4 btn-back" type="button" @click="showStep(step >
...
<div class="overlay" >
<div class="page-content-content" data-slug="tests.homepage" data-side="content">
...
<image xlink:href="..."/>
<img class="ue-logo" src="..." alt="...">
<img src="..." title="..." alt="..." class="img-fluid">
...
<label for="autocomplete-autocomplete-three" class="visually-hidden">

# Segnalazioni elenco reference body
...
Negli ultimi 12 mesi sono state risolte 73 segnalazioni.
</p>
</div>
</div>
...
Se vuoi aggiungere una segnalazione, puoi farlo dopo esserti autenticato con le tue
...
<button class="btn btn-outline-primary w-100 btn-sm" type="button" data-bs-dismiss="modal" aria-label="Chiudi finestra modale">
Chiudi
</button>
</div>
</div>
